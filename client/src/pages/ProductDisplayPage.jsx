  ...
  return (
    <section className='container mx-auto p-4 grid lg:grid-cols-2'>
      <div className=''>
        ...
        <div
          className='bg-white lg:min-h-[65vh] lg:max-h-[65vh] rounded min-h-56 max-h-56 h-full w-full overflow-hidden relative'
      ...
      <p className='bg-green-300 w-fit px-2 rounded-full'>Free Shipping</p>
        ...
        {/* Why Shop Section */}
        <h2 className='font-semibold'>Why shop from Emy's Shoop? </h2>
        <div>
          <div className='flex items-center gap-4 my-4'>
            <img src={image1} alt='superfast delivery' className='w-20 h-20' />
            <div className='text-sm'>
              <div className='font-semibold'>Fast Delivery</div>
              <p>Get your order delivered straight to your doorstep faster than ever from our store!</p>
            </div>
          </div>
          <div className='flex items-center gap-4 my-4'>
          ...
          <div className='flex items-center gap-4 my-4'>
            ...
            <div className='text-sm'>
              ...
              <p>Discover over 5,000 products across personal care, household essentials, and more. Get your order delivered straight to your doorstep, no matter where you are!</p>
            </div>
          </div>
        </div>
